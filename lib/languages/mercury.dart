...
final mercury = Mode(refs: {}, aliases: [
  ...
  Mode(className: "built_in", variants: [Mode(begin: "<=>"), Mode(begin: "<=", relevance: 0), Mode(begin: "=>", relevance: 0), Mode(begin: "/\\\\"), Mode(begin: "\\\\/")]),
  Mode(className: "built_in", variants: [Mode(begin: ":-\\|-->"), Mode(begin: "=", relevance: 0)]),
  ...
  Mode(className: "string", begin: "\"", end: "\"", illegal: "\\n", contains: [backSlashEscape, Mode(className: "subst", begin: "\\\\[abfnrtv]\\|\\\\x[0-9a-fA-F]*\\\\\\|%[-+# *.0-9]*[dioxXucsfeEgGp]", relevance: 0)], relevance: 0),
  Mode(begin: ":-"),
  Mode(begin: "\\.\$")
]);
