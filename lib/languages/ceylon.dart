...
final ceylon = Mode(
    refs: {
      '~contains~4~contains~0~contains~3': Mode(className: "number", begin: "#[0-9a-fA-F_]+|\\\$[01_]+|[0-9_]+(?:\\.[0-9_](?:[eE][+-]?\\d+)?)?[kMGTPmunpf]?", relevance: 0),
      '~contains~4~contains~0~contains~2': Mode(className: "string", begin: "'", end: "'"),
