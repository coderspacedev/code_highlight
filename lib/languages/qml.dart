...
final qml = Mode(
    ...
    contains: [
      ...
      aposStringMode,
      quoteStringMode,
      Mode(className: "string", begin: "`", end: "`", contains: [backSlashEscape, Mode(className: "subst", begin: "\\\$\\{", end: "\\}")]),
      cLineCommentMode,
      cBlockCommentMode,
      ...
      Mode(
          ...
          contains: [
            ...
            Mode(className: "params", begin: "\\(", end: "\\)", excludeBegin: true, excludeEnd: true, contains: [cLineCommentMode, cBlockCommentMode])
          ],
          illegal: "\\[|%"),
