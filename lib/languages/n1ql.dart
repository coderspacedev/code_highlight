...
final n1Ql = Mode(
    ...
    contains: [
      Mode(beginKeywords: "build create index delete drop explain infer|10 insert merge prepare select update upsert|10", end: ";", endsWithParent: true, keywords: {
        "keyword":
        ...
        Mode(className: "string", begin: "\"", end: "\"", contains: [backSlashEscape], relevance: 0),
        Mode(className: "symbol", begin: "`", end: "`", contains: [backSlashEscape], relevance: 2),
        cNumberMode,
        cBlockCommentMode
      ]),
      cBlockCommentMode
