...
final swift = Mode(refs: {
  '~contains~2': Mode(className: "comment", begin: "/\\*", end: "\\*/", contains: [Mode(self: true), phrasalWordsMode, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
  '~contains~0~contains~1~contains~0': Mode(className: "number", begin: "\\b([\\d_]+(\\.[\\deE_]+)?|0x[a-fA-F0-9_]+(\\.[a-fA-F0-9p_]+)?|0b[01_]+|0o[0-7_]+)\\b", relevance: 0),
  ...
  Mode(
      ...
      contains: [
        ...
        Mode(
            ...
            contains: [Mode(self: true), Mode(ref: '~contains~0~contains~1~contains~0'), Mode(ref: '~contains~0'), cBlockCommentMode, Mode(begin: ":")],
            illegal: "[\"']")
      ],
      illegal: "\\[|%"),
  Mode(
