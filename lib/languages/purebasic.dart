...
final purebasic = Mode(
    ...
    contains: [
      ...
      Mode(className: "function", begin: "\\b(Procedure|Declare)(C|CDLL|DLL)?\\b", end: "\\(", excludeEnd: true, returnBegin: true, contains: [Mode(className: "keyword", begin: "(Procedure|Declare)(C|CDLL|DLL)?", excludeEnd: true), Mode(className: "type", begin: "\\.\\w*"), underScoreTitleMode]),
