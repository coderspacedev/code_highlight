...
final stylus = Mode(
    refs: {
      '~contains~4': Mode(className: "number", begin: "#([a-fA-F0-9]{6}|[a-fA-F0-9]{3})"),
    ...
    contains: [
      ...
      cBlockCommentMode,
      Mode(ref: '~contains~4'),
      Mode(begin: "\\.[a-zA-Z][a-zA-Z0-9_-]*(?=[\\.\\s\\n\\[\\:,])", className: "selector-class"),
      Mode(begin: "\\#[a-zA-Z][a-zA-Z0-9_-]*(?=[\\.\\s\\n\\[\\:,])", className: "selector-id"),
      Mode(begin: "\\b(a|abbr|address|article|aside|audio|b|blockquote|body|button|canvas|caption|cite|code|dd|del|details|dfn|div|dl|dt|em|fieldset|figcaption|figure|footer|form|h1|h2|h3|h4|h5|h6|header|hgroup|html|i|iframe|img|input|ins|kbd|label|legend|li|mark|menu|nav|object|ol|p|q|quote|samp|section|span|strong|summary|sup|table|tbody|td|textarea|tfoot|th|thead|time|tr|ul|var|video)(?=[\\.\\s\\n\\[\\:,])", className: "selector-tag"),
      Mode(begin: "&?:?:\\b(after|before|first-letter|first-line|active|first-child|focus|hover|lang|link|visited)(?=[\\.\\s\\n\\[\\:,])"),
      Mode(begin: "@(charset|css|debug|extend|font-face|for|import|include|media|mixin|page|warn|while)\\b"),
      Mode(ref: '~contains~10'),
      cssNumberMode,
      numberMode,
      Mode(className: "function", begin: "^[a-zA-Z][a-zA-Z0-9_-]*\\(.*\\)", illegal: "[\\n]", returnBegin: true, contains: [
        Mode(className: "title", begin: "\\b[a-zA-Z][a-zA-Z0-9_-]*"),
        Mode(className: "params", begin: "\\(", end: "\\)", contains: [Mode(ref: '~contains~4'), Mode(ref: '~contains~10'), aposStringMode, cssNumberMode, numberMode, quoteStringMode])
      ]),
      Mode(
          className: "attribute",
          begin:
          ...
          starts: Mode(end: ";|\$", contains: [Mode(ref: '~contains~4'), Mode(ref: '~contains~10'), aposStringMode, quoteStringMode, cssNumberMode, numberMode, cBlockCommentMode], illegal: "\\.", relevance: 0))
    ]);
