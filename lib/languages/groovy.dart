...
final groovy = Mode(refs: {}, keywords: {
  ...
  aposStringMode,
  Mode(className: "regexp", begin: "\\x7e?\\/[^\\/\\n]+\\/", contains: [backSlashEscape]),
  quoteStringMode,
  Mode(className: "meta", begin: "^#!/usr/bin/env", end: "\$", illegal: "\n"),
  binaryNumberMode,
  Mode(className: "class", beginKeywords: "class interface trait enum", end: "{", illegal: ":", contains: [Mode(beginKeywords: "extends implements"), underScoreTitleMode]),
  cNumberMode,
