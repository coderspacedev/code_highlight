...
final nsis = Mode(
    ...
    contains: [
      ...
      Mode(className: "keyword", begin: "\\!(addincludedir|addplugindir|appendfile|cd|define|delfile|echo|else|endif|error|execute|finalize|getdllversion|gettlbversion|if|ifdef|ifmacrodef|ifmacrondef|ifndef|include|insertmacro|macro|macroend|makensis|packhdr|searchparse|searchreplace|system|tempfile|undef|verbose|warning)"),
      Mode(ref: '~contains~4~contains~2'),
      Mode(ref: '~contains~4~contains~3'),
      Mode(ref: '~contains~4~contains~4'),
      Mode(
