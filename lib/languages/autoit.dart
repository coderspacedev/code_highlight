...
final autoit = Mode(
    refs: {
      '~contains~3': Mode(variants: [binaryNumberMode, cNumberMode]),
      ...
      '~contains~0': Mode(variants: [
        ...
        Mode(className: "comment", begin: "#cs", end: "#ce", contains: [phrasalWordsMode, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
        Mode(className: "comment", begin: "#comments-start", end: "#comments-end", contains: [phrasalWordsMode, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)])
      ]),
    },
