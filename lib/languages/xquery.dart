...
final xquery = Mode(
    ...
    contains: [
      ...
      Mode(className: "built_in", variants: [
        Mode(begin: "\\barray\\:", end: "(?:append|filter|flatten|fold\\-(?:left|right)|for-each(?:\\-pair)?|get|head|insert\\-before|join|put|remove|reverse|size|sort|subarray|tail)\\b"),
        Mode(begin: "\\bmap\\:", end: "(?:contains|entry|find|for\\-each|get|keys|merge|put|remove|size)\\b"),
        Mode(begin: "\\bmath\\:", end: "(?:a(?:cos|sin|tan[2]?)|cos|exp(?:10)?|log(?:10)?|pi|pow|sin|sqrt|tan)\\b"),
        ...
        Mode(begin: "\\bzip\\:", end: "(?:zip\\-file|(?:xml|html|text|binary)\\-entry| (?:update\\-)?entries)\\b"),
        Mode(begin: "\\b(?:util|db|functx|app|xdmp|xmldb)\\:", end: "\\(", excludeEnd: true)
      ]),
      Mode(className: "string", variants: [
        Mode(begin: "\"", end: "\"", contains: [Mode(begin: "\"\"", relevance: 0)]),
        Mode(begin: "'", end: "'", contains: [Mode(begin: "''", relevance: 0)])
      ]),
      Mode(className: "number", begin: "(\\b0[0-7_]+)|(\\b0x[0-9a-fA-F_]+)|(\\b[1-9][0-9_]*(\\.[0-9_]+)?)|[0_]\\b", relevance: 0),
      Mode(className: "comment", begin: "\\(:", end: ":\\)", relevance: 10, contains: [Mode(className: "doctag", begin: "@\\w+")]),
      Mode(className: "meta", begin: "%[\\w-:]+"),
      Mode(className: "title", begin: "\\bxquery version \"[13]\\.[01]\"\\s?(?:encoding \".+\")?", end: ";"),
      Mode(beginKeywords: "element attribute comment document processing-instruction", end: "{", excludeEnd: true),
      Mode(begin: "<([\\w\\._:\\-]+)((\\s*.*)=('|\").*('|\"))?>", end: "(\\/[\\w\\._:\\-]+>)", subLanguage: [
        "xml"
      ], contains: [
