...
final d = Mode(
    ...
    contains: [
      cLineCommentMode,
      cBlockCommentMode,
      Mode(className: "comment", begin: "\\/\\+", end: "\\+\\/", contains: [Mode(self: true), phrasalWordsMode, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)], relevance: 10),
      Mode(className: "string", begin: "x\"[\\da-fA-F\\s\\n\\r]*\"[cwd]?", relevance: 10),
      Mode(className: "string", begin: "\"", contains: [Mode(begin: "\\\\(['\"\\?\\\\abfnrtv]|u[\\dA-Fa-f]{4}|[0-7]{1,3}|x[\\dA-Fa-f]{2}|U[\\dA-Fa-f]{8})|&[a-zA-Z\\d]{2,};", relevance: 0)], end: "\"[cwd]?"),
      ...
      Mode(
          ...
          relevance: 0),
      Mode(className: "number", begin: "\\b((0|[1-9][\\d_]*)|0[bB][01_]+|0[xX]([\\da-fA-F][\\da-fA-F_]*|_[\\da-fA-F][\\da-fA-F_]*))(L|u|U|Lu|LU|uL|UL)?", relevance: 0),
      Mode(className: "string", begin: "'(\\\\(['\"\\?\\\\abfnrtv]|u[\\dA-Fa-f]{4}|[0-7]{1,3}|x[\\dA-Fa-f]{2}|U[\\dA-Fa-f]{8})|&[a-zA-Z\\d]{2,};|.)", end: "'", illegal: "."),
