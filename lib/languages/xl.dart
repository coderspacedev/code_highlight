...
final xl = Mode(
    refs: {
      '~contains~2': Mode(className: "string", begin: "\"", end: "\"", illegal: "\\n"),
    },
    aliases: ["tao"],
    ...
    contains: [
      ...
      Mode(className: "function", begin: "[a-z][^\\n]*->", returnBegin: true, end: "->", contains: [
        Mode(
            className: "title",
            begin: "[a-zA-Z]\\w*",
            relevance: 0,
      ...
      Mode(className: "number", begin: "[0-9]+#[0-9A-Z_]+(\\.[0-9-A-Z_]+)?#?([Ee][+-]?[0-9]+)?"),
      numberMode
    ]);
