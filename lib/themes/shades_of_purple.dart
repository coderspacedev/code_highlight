...
const shadesOfPurpleTheme = {
  'root': TextStyle(backgroundColor: Color(0xff2d2b57), fontWeight: FontWeight.normal, color: Color(0xffe3dfff)),
  ...
  'selector-tag': TextStyle(color: Color(0xfffb9e00), fontWeight: FontWeight.normal),
