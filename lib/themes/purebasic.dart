...
const purebasicTheme = {
  'root': TextStyle(backgroundColor: Color(0xffFFFFDF), color: Color(0xff000000)),
  ...
  'meta-keyword': TextStyle(color: Color(0xff006666), fontWeight: FontWeight.bold),
  'selector-class': TextStyle(color: Color(0xff006666), fontWeight: FontWeight.bold),
  'built_in': TextStyle(color: Color(0xff006666), fontWeight: FontWeight.bold),
  'builtin-name': TextStyle(color: Color(0xff006666), fontWeight: FontWeight.bold),
  ...
  'selector-id': TextStyle(color: Color(0xff924B72), fontWeight: FontWeight.bold),
