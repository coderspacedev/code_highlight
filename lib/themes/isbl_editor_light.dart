...
const isblEditorLightTheme = {
  ...
  'selector-tag': TextStyle(color: Color(0xff000000), fontWeight: FontWeight.bold),
  'meta-keyword': TextStyle(color: Color(0xff000000), fontWeight: FontWeight.bold),
  ...
  'title>.hljs-built_in': TextStyle(color: Color(0xff008080), fontWeight: FontWeight.normal),
