...
const xt256Theme = {
  'root': TextStyle(color: Color(0xffeaeaea), backgroundColor: Color(0xff000000)),
  ...
  'template-variable': TextStyle(color: Color(0xff00ffff), fontWeight: FontWeight.bold),
  ...
  'selector-tag': TextStyle(color: Color(0xff000fff), fontWeight: FontWeight.bold),
