...
const ideaTheme = {
  ...
  'selector-tag': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff000080)),
  'type': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff000080)),
  'selector-id': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff000080)),
  'selector-class': TextStyle(fontWeight: FontWeight.bold, color: Color(0xff000080)),
