...
const atelierPlateauLightTheme = {
  ...
  'deletion': TextStyle(color: Color(0xff1b1818), backgroundColor: Color(0xffca4949)),
  'addition': TextStyle(color: Color(0xff1b1818), backgroundColor: Color(0xff4b8b8b)),
  'root': TextStyle(backgroundColor: Color(0xfff4ecec), color: Color(0xff585050)),
