...
const isblEditorDarkTheme = {
  'root': TextStyle(backgroundColor: Color(0xff404040), color: Color(0xfff0f0f0)),
  ...
  'selector-tag': TextStyle(color: Color(0xfff0f0f0), fontWeight: FontWeight.bold),
  'meta-keyword': TextStyle(color: Color(0xfff0f0f0), fontWeight: FontWeight.bold),
  ...
  'title>.hljs-built_in': TextStyle(color: Color(0xff81bce9), fontWeight: FontWeight.normal),
