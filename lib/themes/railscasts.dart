...
const railscastsTheme = {
  'root': TextStyle(backgroundColor: Color(0xff232323), color: Color(0xffe6e1dc)),
  ...
  'addition': TextStyle(backgroundColor: Color(0xff144212), color: Color(0xffe6e1dc)),
  'deletion': TextStyle(backgroundColor: Color(0xff660000), color: Color(0xffe6e1dc)),
