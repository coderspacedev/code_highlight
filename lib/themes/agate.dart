...
const agateTheme = {
  'root': TextStyle(backgroundColor: Color(0xff333333), color: Color(0xffffffff)),
  ...
  'deletion': TextStyle(color: Color(0xff333333), backgroundColor: Color(0xfffc9b9b)),
  'regexp': TextStyle(color: Color(0xffc6b4f0)),
  'link': TextStyle(color: Color(0xffc6b4f0)),
  'meta': TextStyle(color: Color(0xfffc9b9b)),
  'addition': TextStyle(backgroundColor: Color(0xffa2fca2), color: Color(0xff333333)),
};
