...
const gradientDarkTheme = {
  ...
  'selector-tag': TextStyle(color: Color(0xffAEFBFF), fontWeight: FontWeight.bold),
  'selector-id': TextStyle(color: Color(0xffAEFBFF), fontWeight: FontWeight.bold),
  'template-tag': TextStyle(color: Color(0xffAEFBFF), fontWeight: FontWeight.bold),
  ...
  'selector-class': TextStyle(color: Color(0xffF19FFF), fontWeight: FontWeight.bold),
